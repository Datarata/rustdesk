...
pub const WIN_TOPMOST_INJECTED_PROCESS_EXE: &'static str = "RuntimeBroker_savoldesk.exe";
pub const INJECTED_PROCESS_EXE: &'static str = WIN_TOPMOST_INJECTED_PROCESS_EXE;
pub(super) const PRIVACY_WINDOW_CLASS: &'static str = "SavolDeskPrivacyWindowClass";
pub(super) const PRIVACY_WINDOW_NAME: &'static str = "SavolDeskPrivacyWindow";
